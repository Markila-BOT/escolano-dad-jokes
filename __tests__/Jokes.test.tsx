// snapshot
// it should show prev and next button when result is more than 20 from search query
...
describe("Jokes", () => {
  it("should renders the Jokes component", () => {
    const { container } = render(<Jokes {...MOCK_DATA_JOKES} />);
    expect(screen.getByTestId("joke-main")).toBeTruthy();
    expect(container).toMatchSnapshot();
  });

  it("should renders the Jokes component with 20 initial results", () => {
    render(<Jokes {...MOCK_DATA_JOKES} />);
    const jokeRow = screen.queryAllByTestId("joke-row");
    expect(jokeRow).toHaveLength(20);
  });
});
